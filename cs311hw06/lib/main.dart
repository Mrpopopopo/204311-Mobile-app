...
class _MyPokemonApp extends State<MyPokemonApp> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        ...
        child: Consumer<PokemonService>(builder: (_, pokemonService, __) {
          return MaterialApp(
            title: 'Pokemon Demo',
            theme: ThemeData(
              primarySwatch: MaterialColor(pokemonService.pokeColor,
                  shadeColor), // chooes color from conditon in pokemon service
            ),
